  ...
  return (
    <div>
      <div className="container-pricing">
        <div className="badge-pricing">Pricing</div>
        <div className="title">Plans to Fit Your Business</div>

        <div className="toggle">
          <label
            htmlFor="AcceptConditions"
            className="relative inline-block h-8 w-14 cursor-pointer rounded-full bg-blue-300 transition [-webkit-tap-highlight-color:_transparent] has-[:checked]:bg-purple-500"
          >
            <input
              type="checkbox"
              id="AcceptConditions"
